...
public class XDACommonFunction {
	...
	public static long readIntegerAccording2BitsParam(InputStream theStream,
		...
		switch (bitsParam) {
			case 0x02:
				return XDACommonFunction.readShort(theStream);
			case 0x08:
				return XDACommonFunction.readLong(theStream);
			default:
				return XDACommonFunction.readInt(theStream);
		}
	}
	...
	public static long readIntegerAccording2BitsParam(RandomAccessFile theFile,
		...
		switch (bitsParam) {
			case 0x02:
				return XDACommonFunction.readShort(theFile);
			case 0x08:
				return XDACommonFunction.readLong(theFile);
			default:
				return XDACommonFunction.readInt(theFile);
		}
	}
	...
	public static void writeIntegerAccording2BitsParam(
		...
		switch (bitsParam) {
			case 0x02:
				XDACommonFunction.writeShort(theFile, integer);
			case 0x08:
				XDACommonFunction.writeLong(theFile, integer);
			default:
				XDACommonFunction.writeInt(theFile, integer);
		}
	}
	...
	public static void writeIntegerAccording2BitsParam(OutputStream theStream,
		...
		switch (bitsParam) {
			case 0x02:
				XDACommonFunction.writeShort(theStream, integer);
			case 0x08:
				XDACommonFunction.writeLong(theStream, integer);
			default:
				XDACommonFunction.writeInt(theStream, integer);
		}
	}
